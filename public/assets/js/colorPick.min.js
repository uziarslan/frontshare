...
!function ($) {
    ...
    $.colorPick = function (element, options) {
        ...
        options.str && (this.options.str = $.extend({}, $.fn.colorPick.defaults.str, options.str));
    ...
    $.colorPick.prototype = {
        ...
        show: function (element, left, top) {
            ...
            if ($.fn.colorPick.defaults.allowCustomColor) {
